<template>
  <section class="relative py-20 md:py-24 overflow-hidden">
    <img class="absolute top-0 left-0" src="https://i.pinimg.com/564x/9c/36/4a/9c364a97cc5537e3d0534b9b08aa4dc1.jpg" alt="">
    <div class="relative container px-4 mx-auto">
      <div class="max-w-7xl mx-auto px-8 md:px-16 py-12 sm:py-20 bg-gray-900 rounded-4xl">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
            <div class="max-w-lg mx-auto">
              <h4 class="font-heading text-4xl sm:text-5xl text-white font-semibold">Sign up for our newsletter</h4>
            </div>
          </div>
          <div class="w-full lg:w-1/2 px-4">
            <div class="max-w-lg lg:ml-auto">
              <p class="text-lg font-semibold text-gray-50 mb-10">
              ...
              <div class="sm:flex mb-2 items-center">
                <input
                  ...
                  type="email"
                  placeholder="duplantisTrends@gmail.com"
                />
                <button
                  class="relative group inline-block flex-shrink-0 w-full sm:w-auto py-3 px-5 text-sm font-semibold text-orange-50 hover:text-orange-900 bg-orange-900 rounded-md transition duration-300 overflow-hidden"
                  type="submit"
                >
              ...
              <span class="block text-xs font-semibold text-gray-50">We care about your data in our privacy policy</span>
            </div>
          </div>
        </div>
      </div>
